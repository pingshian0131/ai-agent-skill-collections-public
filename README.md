...
| [commit-and-push-mr](./commit-and-push-mr/) | 自動分析 Git 變更產生語意化 commit message，push 到遠端分支，並可用 glab 建立 GitLab Merge Request。 |
...
| [qa-list-generator](./qa-list-generator/) | 分析 function、method 或 class 的查詢邏輯（QuerySet、SQL、API 呼叫等），自動產生結構化的 QA List（手動測試清單）。 |
